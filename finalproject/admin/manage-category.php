...
<a href="<?php echo SITEURL; ?>admin/add-category.php" class="btn-primary">Add Catogry </a>
...
<?php
$sql="SELECT * FROM tbl_category"; //get query database var
...
<td>
<a href="<?php echo SITEURL; ?>admin/update-category.php?id=<?php echo $id;?>" class= "btn-secondry">Update</a>
<!-- delete id and image-->
